...
resource sessionHost 'Microsoft.Compute/virtualMachines@2019-07-01' = [for i in range(0, count): {
  ...
  properties: {
    ...
    storageProfile: {
      imageReference: {
        //id: '/subscriptions/d757cd6b-c3ef-4a9f-8208-531893fa662f/resourceGroups/az-azure-virtual-training-day-rg/providers/Microsoft.Compute/images/avd-temp-000-image-20211117192122'
